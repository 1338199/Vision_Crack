...
def download():     # download tiger and kittycat image
    ...
    for category in categories:
        os.makedirs('/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/data/%s' % category, exist_ok=True)
        with open('/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/imagenet_%s.txt' % category, 'r') as file:
            urls = file.readlines()
            n_urls = len(urls)
            for i, url in enumerate(urls):
                try:
                    urlretrieve(url.strip(), '/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/data/%s/%s' % (category, url.strip().split('/')[-1]))
...
def load_data():
    imgs = {'tiger': [], 'kittycat': []}
    for k in imgs.keys():
        dir = '/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/data/' + k
...
class Vgg16:
    ...
    def save(self, path='/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/model/transfer_learn'):
        saver = tf.train.Saver()
...
def train():
    ...
    vgg = Vgg16(vgg16_npy_path='/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/vgg16.npy')
    print('Net built')
    for i in range(100):
    ...
    vgg.save('/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/model/transfer_learn')      # save learned fc layers


def eval():
    vgg = Vgg16(vgg16_npy_path='/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/vgg16.npy',
                restore_from='/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/model/transfer_learn')
    vgg.predict(
        ['/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/data/kittycat/000129037.jpg',
         '/Users/johnsauhu/PycharmProjects/tut/for_transfer_learning/data/tiger/391412.jpg'])
